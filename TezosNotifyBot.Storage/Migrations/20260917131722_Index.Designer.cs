...
namespace TezosNotifyBot.Storage.Migrations
{
    ...
    [Migration("20260917131722_Index")]
    partial class Index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TezosNotifyBot.Domain.User", b =>
                {
                    ...
                    b.Property<int?>("MaxAddrCount")
                        .HasColumnType("integer")
                        .HasColumnName("max_addr_count");

                    b.Property<int>("NetworkIssueNotify")
                        .HasColumnType("integer")
                        .HasColumnName("network_issue_notify");

                    b.Property<string>("NotifyStat")
                        .HasColumnType("text")
                        .HasColumnName("notify_stat");
            ...
            modelBuilder.Entity("TezosNotifyBot.Domain.UserAddress", b =>
                {
                    ...
                    b.HasIndex("Address")
                        .HasDatabaseName("ix_user_address_address");
